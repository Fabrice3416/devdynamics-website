...
$echouer = [
    ...
    ['Rémunération', 'Consommer du budget par le dossier de versement à la DGI', 'budget par le dossier de versement'],
    ['Restitution', 'Écrire une dépense dans une période figée', 'ecriture datee dans une periode figee'],
    ['Restitution', 'Modifier un rapport transmis sans version rectificative', 'rapport transmis sans version rectificative'],
    ...
    ['Signature', 'Apposer le spécimen d\'un autre titulaire', 'ne se lit que sous son titulaire'],
    ['Dépenses', 'Approuver un dossier dont on est soi-même le bénéficiaire', 'dont on est le beneficiaire'],
    ['Dépenses', 'Approuver un dossier en conflit sans être le suppléant désigné', 'suppleant d\'approbation est un parametre'],
    ['Dépenses', 'Clore un dossier dont la mention hors taxe n\'est pas levée', 'case de mention hors taxe'],
...
$reussir = [
    ...
    ['Cycle complet', 'Rejouer un mois réel avec une douzaine de dossiers de types différents', 'une douzaine de dossiers de types'],
    ['Cycle complet', 'Mener un dossier de chaque type de sa création à sa clôture', 'mené de sa création à sa clôture'],
